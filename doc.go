...
(the end time of a Compositor (that makes it a signals.LimitedSignal), comes from the longest contained signals.Signal's, so at least one should be a Sound, not, for example, all Tones. Silence could be used for this.)
